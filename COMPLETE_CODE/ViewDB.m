...
curs = exec(conn,['SELECT * FROM legop4.lego_set_parameters_of_set_id']);
curs = fetch(curs);
lego_set_parameters_of_set_id = curs.Data;

curs = exec(conn,['SELECT * FROM legop4.lego_box_status']);
curs = fetch(curs);
lego_box_status = curs.Data;
